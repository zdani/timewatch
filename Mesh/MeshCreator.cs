...
/*
 * Renderes the object in the game world
 * Object must be created as the child of an existing parent
*/
...
public class MeshCreator
{
	...
	public MeshCreator (GameObject objParent, string objName, Vector3[] points) {
		this.points = points;
		msh = new Mesh();
		gameObj = new GameObject(objName);
		gameObj.transform.parent = objParent.transform;
    }
